...
MIDDLEWARE = [
    ...
    'core_app.middleware.LoginRequiredMiddleware',
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'bioprofile.context_processors.profile_picture',
            ],
        },
    },
]
...
# Media files (FileField or ImageField)
...
# Django cronjobs configuration
#
CRONJOBS = [
    ('* * * * *', 'setting.cron.email_scheduler_job')
]
